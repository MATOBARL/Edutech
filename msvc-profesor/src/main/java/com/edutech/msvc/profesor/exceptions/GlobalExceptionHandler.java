...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handlePrevisionException(ProfesorException exception){
        ...
        if(exception.getMessage().contains("no se encuentra en la base de datos")) {
            ...
            Map<String, String> errorMap = Collections.singletonMap("Prevision no encontrada", exception.getMessage());
            ...
            Map<String, String> errorMap = Collections.singletonMap("Prevision existente", exception.getMessage());
